...
/**
 * {@link PermissionService} Unit Test.
 * 
 * @author madmath03
 */
public class PermissionServiceTest
    extends AbstractGenericServiceTest<Permission, PermissionDto, PermissionService> {
  ...
  @Override
  protected IPermissionRepository buildMockRepository() {
    return mock(IPermissionRepository.class);
  }

  @Override
  public IPermissionRepository getMockRepository() {
    return (IPermissionRepository) super.getMockRepository();
  }
  ...
  /**
   * Test method for {@link PermissionService#add(Permission)}.
   */
  @Override
  @Test
  public void testAdd() {
  ...
  /**
   * Test method for {@link PermissionService#findById(java.util.UUID)}.
   * 
  ...
  /**
   * Test method for {@link PermissionService#findAllByName(java.lang.String)}.
   */
  @Test
