...
/**
 * {@link TypeService} Unit Test.
 * 
 * @author madmath03
 */
public class TypeServiceTest extends AbstractGenericServiceTest<Type, TypeDto, TypeService> {
  ...
  @Override
  protected ITypeRepository buildMockRepository() {
    return mock(ITypeRepository.class);
  }

  @Override
  public ITypeRepository getMockRepository() {
    return (ITypeRepository) super.getMockRepository();
  }
  ...
  /**
   * Test method for {@link TypeService#add(Type)}.
   */
  @Override
  @Test
  public void testAdd() {
  ...
  /**
   * Test method for {@link TypeService#findById(java.util.UUID)}.
   * 
  ...
  /**
   * Test method for {@link TypeService#findAllContainingNameIgnoreCase(java.lang.String)}.
   */
  @Test
