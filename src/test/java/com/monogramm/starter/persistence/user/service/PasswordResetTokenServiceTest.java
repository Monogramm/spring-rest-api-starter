...
public class PasswordResetTokenServiceTest extends
    AbstractGenericServiceTest<PasswordResetToken, PasswordResetTokenDto, PasswordResetTokenService> {

  private static final UUID ID = UUID.randomUUID();
  private static final String TOKEN = PasswordResetTokenServiceTest.class.getSimpleName();
  ...
  @Override
  protected PasswordResetTokenService buildTestService() {
    return new PasswordResetTokenService(getMockRepository(), getMockUserRepository(),
        getMockAuthenticationFacade());
  }

  @Override
  protected IPasswordResetTokenRepository buildMockRepository() {
    return mock(IPasswordResetTokenRepository.class);
  }

  @Override
  public IPasswordResetTokenRepository getMockRepository() {
    return (IPasswordResetTokenRepository) super.getMockRepository();
  }
