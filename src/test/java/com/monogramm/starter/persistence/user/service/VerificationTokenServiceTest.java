 ...
 * @author madmath03
 */
public class VerificationTokenServiceTest extends
    AbstractGenericServiceTest<VerificationToken, VerificationTokenDto, VerificationTokenService> {

  private static final UUID ID = UUID.randomUUID();
  private static final String TOKEN = VerificationTokenServiceTest.class.getSimpleName();
  ...
  @Override
  protected VerificationTokenService buildTestService() {
    return new VerificationTokenService(getMockRepository(), getMockUserRepository(),
        getMockAuthenticationFacade());
  }

  @Override
  protected IVerificationTokenRepository buildMockRepository() {
    return mock(IVerificationTokenRepository.class);
  }

  @Override
  public IVerificationTokenRepository getMockRepository() {
    return (IVerificationTokenRepository) super.getMockRepository();
  }
